...
public class Principal {
    ...
    private final String API_KEY = "&apikey=f0df5949";
    ...
    private void buscarSerieWeb() {
        ...
        // ⬇️ Ya no vamos a adicionar datos en esta lista sino que vamos a guardarlos
    ...
    private void filtrarSeriesPorTemporadaYEvaluacion(){
        ...
        var input = teclado.nextLine().replace(",", ".");
        double evaluacion = Double.parseDouble(input);
    ...
    private void buscarTop5Episodios(){
        ...
        if (serieBuscada.isPresent()){
            ...
            List<Episodio> topEpisodios = repositorio.top5pisodios(serie);
